...
EpubChapter _$EpubChapterFromJson(Map<String, dynamic> json) => EpubChapter(
  ...
  href: const EpubHrefConverter().fromJson(json['href'] as String),
  id: const EpubHrefConverter().fromJson(json['id'] as String),
...
Map<String, dynamic> _$EpubChapterToJson(EpubChapter instance) =>
    <String, dynamic>{
      ...
      'href': const EpubHrefConverter().toJson(instance.href),
      'id': const EpubHrefConverter().toJson(instance.id),
...
Map<String, dynamic> _$EpubSearchResultToJson(EpubSearchResult instance) =>
    <String, dynamic>{'cfi': instance.cfi, 'excerpt': instance.excerpt};
